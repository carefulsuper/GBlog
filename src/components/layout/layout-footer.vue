<template>
    <div id="layout-footer">
        <div class="footer-main">
            ...
            <div class="footer-item">
                <div>本站已苟活 {{runTimeInterval-1000}}</div>
                <div><a target="_blank" class="out-link" href="#">☞后台管理</a></div>
            </div>
        </div>
        <div class="copyright">Copyright © 2023 by <a target="_blank" class="out-link" href="https://gitee.com/confuse-truth-and-falsehood">carefulsuper.cn</a> . All rights reserved.</div>
    </div>
</template>
