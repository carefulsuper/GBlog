        ...
        <div class="site-content">
            <section-title>
                <div class="newPage-header">
                    ...
                    <div class="apply"><router-link to="/newPage">+ 新建</router-link></div>
                </div>
            </section-title>
            <!---说明--->
            <div class="statement">
            ...
            <!----->
            <hr/>
            <div class="newPage-list animate">
                <div class="newPage-item" v-for="item in list" :key="item.id"><a target="_blank" :href="item.path"><div class="site-name">{{item.siteName}}</div><div class="site-detail">{{item.desc}}</div></a></div>
            </div>
        </div>
    </div>
</template>
